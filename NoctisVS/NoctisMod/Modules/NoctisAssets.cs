...
{
    internal static class NoctisAssets
    {
        ...
        internal static void PopulateAssets()
        {
            ...
            //sword swing
            noctisHitEffect = NoctisAssets.LoadEffect("hitEffect");
            noctisSwingEffect = NoctisAssets.LoadEffect("swingEffect", true);
            noctisSwingEffectMedium = NoctisAssets.LoadEffect("swingEffectMedium", true);
            noctisSwingEffectLarge = NoctisAssets.LoadEffect("swingEffectLarge", true);

            //particles
            noctisDashEffect = NoctisAssets.LoadEffect("DashParticle", true);

            //fake projectiles
            swordThrowParticle = NoctisAssets.LoadEffect("swordThrow", true);
            polearmThrowParticle = NoctisAssets.LoadEffect("polearmThrow", true);
            armigerSwordParticle = NoctisAssets.LoadEffect("ArmigerSword", true);
        ...
        public static Material CreateMaterial(string materialName, float emission, Color emissionColor, float normalStrength)
        {
            ...
            Material tempMat = NoctisAssets.mainAssetBundle.LoadAsset<Material>(materialName);
        ...
        {
            return NoctisAssets.CreateMaterial(materialName, 0f);
        }

        public static Material CreateMaterial(string materialName, float emission)
        {
            return NoctisAssets.CreateMaterial(materialName, emission, Color.white);
        }

        public static Material CreateMaterial(string materialName, float emission, Color emissionColor)
        {
            return NoctisAssets.CreateMaterial(materialName, emission, emissionColor, 0f);
        }
    }
}