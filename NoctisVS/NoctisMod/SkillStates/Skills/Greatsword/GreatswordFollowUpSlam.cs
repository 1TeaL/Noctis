...
namespace NoctisMod.SkillStates
{
    public class GreatswordFollowUpSlam : BaseSkillState
    {
        ...
        public override void FixedUpdate()
        {
            ...
            {
                hasFired = true;
                EffectManager.SimpleMuzzleFlash(Modules.NoctisAssets.noctisSwingEffectMedium, base.gameObject, "SwordSwingDown", true);
                ...
                EffectManager.SpawnEffect(Modules.NoctisAssets.sonicboomEffectPrefab, new EffectData
                {
